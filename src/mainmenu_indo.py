...
def main_menu():
    ...
    if "firsttime.txt" not in entry:
        ...
        file.close()
        # game_help() <- Automatically calls "How to play menu"
    ...
    while Running:
        ...
        bg = pygame.image.load('assets/indonesia/bg/ROTMAINMENU.jpg') 
        ...
        start_button = pygame.image.load('assets/indonesia/Tombol/Tombol_mengapung/Glow_Mulai.png') 
        start_button = pygame.transform.scale(start_button,(450,80))
        screen.blit(start_button,(rectX, rectY//2))
        start_button_dark = pygame.image.load('assets/indonesia/Tombol/Tombol/Idle_Mulai.png')
        start_button_dark = pygame.transform.scale(start_button_dark, (450,80))
        
        
        button_2 = pygame.Rect(rectX, math.floor(rectY//1.35), 450, 80)
        setting_button = pygame.image.load('assets/indonesia/Tombol/Tombol_mengapung/Glow_Pengaturan.png') 
        setting_button = pygame.transform.scale(setting_button,(450,80))
        screen.blit(setting_button,(rectX, rectY//1.35))
        setting_button_dark = pygame.image.load('assets/indonesia/Tombol/Tombol/Idle_Pengaturan.png')
        setting_button_dark = pygame.transform.scale(setting_button_dark, (450,80))

        
        button_3 = pygame.Rect(rectX, math.floor(rectY), 450, 80)
        help_button = pygame.image.load('assets/indonesia/Tombol/Tombol_mengapung/Glow_Cara.png') 
        help_button = pygame.transform.scale(help_button,(450,80))
        screen.blit(help_button,(rectX, rectY))
        help_button_dark = pygame.image.load('assets/indonesia/Tombol/Tombol/Idle_Cara.png')
        help_button_dark = pygame.transform.scale(help_button_dark, (450,80))
        
        button_4 = pygame.Rect(rectX, math.floor(rectY//0.8), 450, 80)
        quit_button = pygame.image.load('assets/indonesia/Tombol/Tombol_mengapung/Glow_Keluar.png') 
        quit_button = pygame.transform.scale(quit_button,(450,80))
        screen.blit(quit_button,(rectX, rectY//(0.8)))        
        quit_button_dark = pygame.image.load('assets/indonesia/Tombol/Tombol/Idle_Keluar.png')
        quit_button_dark = pygame.transform.scale(quit_button_dark, (450,80))

        #bendera
        button_5 = pygame.Rect((int(10*WIDTH//12-40),(int(10*HEIGHT//11))),(180,80))
        flag_english = pygame.image.load('assets/Flag/Flag_Indonesia.png')
        flag_english = pygame.transform.scale(flag_english, (750,80))
        screen.blit(flag_english, ((int(10*WIDTH//12-320),(int(10*HEIGHT//11)))))
        
        if button_1.collidepoint((mx, my)):
            screen.blit(start_button_dark, (rectX, rectY//2))

            if click:
                start()
                Running = False
        if button_2.collidepoint((mx, my)):
            screen.blit(setting_button_dark, (rectX, rectY//1.35))
            if click:
                setting()
        if button_3.collidepoint((mx, my)):
            screen.blit(help_button_dark, (rectX, rectY))

            if click:
                game_help()
        if button_4.collidepoint((mx, my)):
            screen.blit(quit_button_dark, (rectX, rectY//0.8))
...
def setting():
    ...
    while running:
        ...
        bgs = pygame.image.load('assets/indonesia/pengaturan/Pengaturan.png') 
...
def game_help():
    ...
    POG = pygame.image.load('assets/indonesia/carabermain/Bagian.png') 
    POG = pygame.transform.scale(POG,(int(WIDTH*3//4),int(HEIGHT*3//4)))
    HTP = pygame.image.load('assets/indonesia/carabermain/Cara.png') 
...
- 13/11/2020 [AM 8:36] Fixed blinking tick <- Marvin
